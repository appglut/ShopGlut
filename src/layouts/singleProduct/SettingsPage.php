...
class SettingsPage {
	...
	public $menu_slug = 'singleproduct';
	...
	<form id="shopglut_shop_layouts" method="post" action="">
				...
				<div class="shopglut_layout_contents">
					...
					<div class="shopglut_editor_header">
						...
						<div class="back-to-menu">
							...
							<a href="<?php echo esc_url( admin_url( 'admin.php?page=shopglut_layouts&view=single_product' ) ); ?>"
					...
					<button type="button" id="toggle-settings-button" class="toggle-button"><?php echo esc_html__('Hide', 'shopglut');  ?></button>
						...
						<div class="submitbox" id="submitpost">
								<div id="singleProductLayout-publishing-action">
									<button type="button" id="singleProduct-reset-settings-button" class="btn btn-fullwidth btn-secondary"
						...
						<div id="shopg-singleProduct-layout-container" class="shopg-admin-edit-panel">
		...
		<style>
			...
			#shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container,
			body.wp-admin #shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container,
			#poststuff #shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container,
			#post-body #shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container {
				width: 95% !important;
			...
			#shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container > *,
			#shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container .postbox {
				width: 100% !important;
				max-width: 100% !important;
			}

			#shopg-singleProduct-layout-container {
				transition: width 0.3s ease, max-width 0.3s ease !important;
			}

			/* Force collapsed state width via class on container itself */
			#shopg-singleProduct-layout-container.collapsed {
				width: 95% !important;
				max-width: 95% !important;
				flex: 0 0 95% !important;
			}

			/* Expand template preview max-width when settings are collapsed */
			#shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container .shopglut-single-product-container,
			#shopg-singleProduct-layout-container.collapsed .shopglut-single-product-container,
			#shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container .single-product-container,
			#shopg-singleProduct-layout-container.collapsed .single-product-container,
			#shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container .single-product-template3,
			#shopg-singleProduct-layout-container.collapsed .single-product-template3,
			#shopg-cart-layout-settings.collapsed ~ #shopg-singleProduct-layout-container .html-preview-background,
			#shopg-singleProduct-layout-container.collapsed .html-preview-background {
				max-width: 100% !important;
				width: 100% !important;
			}
