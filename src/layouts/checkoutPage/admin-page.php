...
<div class="wrap shopglut-checkout-manager-wrap">
	<div class="shopglut-checkout-manager-header">
		<h1><?php echo esc_html__( 'ShopGlut Checkout Field Editor', 'shopglut' ); ?></h1>
		<p class="shopglut-checkout-manager-description">
			<?php echo esc_html__( 'Customize your WooCommerce checkout page by adding, editing, or removing fields to collect the information you need from your customers.', 'shopglut' ); ?>
		</p>
	</div>
	...
	<div class="shopglut-checkout-manager-tabs-container">
		<nav class="shopglut-checkout-manager-tabs">
			<a href="?page=<?php echo esc_attr( $this->menu_slug ); ?>&tab=fields"
				class="shopglut-checkout-manager-tab <?php echo $current_tab === 'fields' ? 'active' : ''; ?>"><?php echo esc_html__( 'Classic Checkout Fields', 'shopglut' ); ?></a>
			<?php if ( $blocks_checkout_enabled ) : ?>
				<a href="?page=<?php echo esc_attr( $this->menu_slug ); ?>&tab=block_fields"
					class="shopglut-checkout-manager-tab <?php echo $current_tab === 'block_fields' ? 'active' : ''; ?>"><?php echo esc_html__( 'Block Checkout Fields', 'shopglut' ); ?></a>
			<?php endif; ?>
			<a href="?page=<?php echo esc_attr( $this->menu_slug ); ?>&tab=advanced"
				class="shopglut-checkout-manager-tab <?php echo $current_tab === 'advanced' ? 'active' : ''; ?>"><?php echo esc_html__( 'Advanced Settings', 'shopglut' ); ?></a>
			<a href="?page=<?php echo esc_attr( $this->menu_slug ); ?>&tab=import_export"
				class="shopglut-checkout-manager-tab <?php echo $current_tab === 'import_export' ? 'active' : ''; ?>"><?php echo esc_html__( 'Import/Export', 'shopglut' ); ?></a>
		</nav>
		...
		<div class="shopglut-checkout-manager-tab-content <?php echo $current_tab === 'fields' ? 'active' : ''; ?>">
			<?php if ( $current_tab === 'fields' ) : ?>
					...
					<nav class="shopglut-checkout-manager-tabs">
						...
						foreach ( $field_sections as $section ) : ?>
							<a href="#<?php echo esc_attr( $section ); ?>-fields"
								...
								<?php echo esc_html__( 'Fields', 'shopglut' ); ?></a>
						<?php endforeach; ?>
						<a href="#add-new-field"
							class="shopglut-checkout-manager-tab section-tab add-tab"><?php echo esc_html__( 'Add New Field', 'shopglut' ); ?></a>
					</nav>
				</div>
						...
						<div class="shopglut-checkout-manager-card">
							<div class="shopglut-checkout-manager-card-header">
								<h3><?php echo esc_html( ucfirst( $section ) ); ?>
									<?php echo esc_html__( 'Fields', 'shopglut' ); ?>
									<div class="drag-instruction">
										<span class="dashicons dashicons-info"></span>
										<?php echo esc_html__( 'Drag and drop rows to reorder fields', 'shopglut' ); ?>
									</div>
								</h3>
								...
								<div class="shopglut-checkout-manager-card-actions">
									<button type="button" class="shopglut-checkout-manager-button secondary enable-all-fields"
										data-section="<?php echo esc_attr( $section ); ?>"><?php echo esc_html__( 'Enable All', 'shopglut' ); ?></button>
									<button type="button" class="shopglut-checkout-manager-button secondary disable-all-fields"
										data-section="<?php echo esc_attr( $section ); ?>"><?php echo esc_html__( 'Disable All', 'shopglut' ); ?></button>
									<button type="button" class="shopglut-checkout-manager-button secondary reset-fields"
										data-section="<?php echo esc_attr( $section ); ?>"><?php echo esc_html__( 'Reset to Default', 'shopglut' ); ?></button>
								</div>
							</div>
								...
								<table class="shopglut-checkout-manager-table shopglut-checkout-manager-fields-table widefat">
									<thead>
										<tr>
											...
											<th><?php echo esc_html__( 'Field ID', 'shopglut' ); ?></th>
											<th><?php echo esc_html__( 'Type', 'shopglut' ); ?></th>
											<th><?php echo esc_html__( 'Label', 'shopglut' ); ?></th>
											<th><?php echo esc_html__( 'Required', 'shopglut' ); ?></th>
											<th><?php echo esc_html__( 'Placeholder', 'shopglut' ); ?></th>
											<th><?php echo esc_html__( 'Display', 'shopglut' ); ?></th>
									...
									<tbody class="checkout-fields-list">
										...
										if ( ! empty( $section_fields ) ) :
											foreach ( $section_fields as $field_id => $field ) :
												...
												<tr class="field-row sortable-row <?php echo ! $field_enabled ? 'disabled' : ''; ?>"
													...
													<td class="sort-handle">
														<span class="dashicons dashicons-menu" title="<?php echo esc_attr__( 'Drag to reorder', 'shopglut' ); ?>"></span>
													</td>
													...
													<td>
														<?php if ( $display_in_emails ) : ?>
															<span class="dashicons dashicons-email"
																title="<?php echo esc_attr__( 'Display in Emails', 'shopglut' ); ?>"></span>
														<?php endif; ?>
														<?php if ( $display_in_order ) : ?>
															<span class="dashicons dashicons-clipboard"
																title="<?php echo esc_attr__( 'Display in Order', 'shopglut' ); ?>"></span>
														<?php endif; ?>
													</td>
													<td class="field-actions">
														...
														<?php if ( $is_custom ) : ?>
															<a href="#" class="delete-field delete-action"
																...
																<?php echo esc_html__( 'Delete', 'shopglut' ); ?>
															</a>
														<?php endif; ?>
														...
														<a href="#" class="toggle-field"
															...
															<?php if ( $field_enabled ) : ?>
																...
																<?php echo esc_html__( 'Disable', 'shopglut' ); ?>
															<?php else : ?>
											...
											<tr>
												<td colspan="7">
													<?php echo esc_html__( 'No fields found for this section.', 'shopglut' ); ?>
												</td>
											</tr>
										<?php endif; ?>
									</tbody>
				...
				<div id="add-new-field" class="shopglut-checkout-manager-section-content">
					<div class="shopglut-checkout-manager-card">
						<div class="shopglut-checkout-manager-card-header">
							<h3><?php echo esc_html__( 'Add New Checkout Field', 'shopglut' ); ?></h3>
							<div class="drag-instruction">
								<span class="dashicons dashicons-info"></span>
								<?php echo esc_html__( 'Drag and drop rows to reorder fields', 'shopglut' ); ?>
							</div>
							...
							<form method="post" action="" id="add-field-form">
								...
								<table class="shopglut-checkout-manager-form-table">
									<tr>
										<th scope="row">
											<label
												for="new_field_section"><?php echo esc_html__( 'Section', 'shopglut' ); ?></label>
										</th>
										<td>
									...
									<tr>
										<th scope="row">
											<label
												for="new_field_id"><?php echo esc_html__( 'Field ID', 'shopglut' ); ?></label>
										</th>
										<td>
											<input type="text" name="new_field_id" id="new_field_id" class="regular-text"
												required>
											<p class="description">
												<?php echo esc_html__( 'Unique identifier for the field (e.g. custom_field). The section prefix will be added automatically.', 'shopglut' ); ?>
											</p>
										</td>
									</tr>
									<tr>
										<th scope="row">
											<label
												for="new_field_type"><?php echo esc_html__( 'Field Type', 'shopglut' ); ?></label>
										</th>
										<td>
									...
									<tr>
										<th scope="row">
											<label
												for="new_field_label"><?php echo esc_html__( 'Label', 'shopglut' ); ?></label>
										</th>
										<td>
									...
									<tr>
										<th scope="row">
											<label
												for="new_field_placeholder"><?php echo esc_html__( 'Placeholder', 'shopglut' ); ?></label>
										</th>
										<td>
									...
									<tr>
										<th scope="row">
											<label
												for="new_field_class"><?php echo esc_html__( 'CSS Class', 'shopglut' ); ?></label>
										</th>
										<td>
											<input type="text" name="new_field_class" id="new_field_class"
												class="regular-text" value="form-row-wide">
											<p class="description">
												<?php echo esc_html__( 'Space-separated list of CSS classes. Common values: form-row-first, form-row-last, form-row-wide', 'shopglut' ); ?>
											</p>
										</td>
									</tr>
									<tr>
										<th scope="row">
											<?php echo esc_html__( 'Required', 'shopglut' ); ?>
										</th>
										<td>
											<label for="new_field_required">
												<input type="checkbox" name="new_field_required" id="new_field_required"
													value="1">
												<?php echo esc_html__( 'Make this field required', 'shopglut' ); ?>
											</label>
										</td>
									</tr>
									<tr>
										<th scope="row">
											<label
												for="new_field_priority"><?php echo esc_html__( 'Priority', 'shopglut' ); ?></label>
										</th>
										<td>
											<input type="number" name="new_field_priority" id="new_field_priority"
												class="small-text" value="100">
											<p class="description">
												<?php echo esc_html__( 'Controls the display order. Lower numbers display first.', 'shopglut' ); ?>
											</p>
										</td>
									</tr>
									<tr class="field-options" style="display:none;">
										<th scope="row">
											<label
												for="new_field_options"><?php echo esc_html__( 'Options', 'shopglut' ); ?></label>
										</th>
										<td>
											<textarea name="new_field_options" id="new_field_options" rows="5"
												cols="50"></textarea>
											<p class="description">
												<?php echo esc_html__( 'Enter each option on a new line. Format: value|label (e.g. option_1|Option 1). If no label is specified, the value will be used as the label.', 'shopglut' ); ?>
											</p>
										</td>
									</tr>
									<tr>
										<th scope="row">
											<?php echo esc_html__( 'Validation', 'shopglut' ); ?>
										</th>
										<td>
											<fieldset>
									...
									<tr>
										<th scope="row">
											<?php echo esc_html__( 'Display Options', 'shopglut' ); ?>
										</th>
										<td>
											<fieldset>
												<legend class="screen-reader-text">
												...
												<label for="new_field_display_in_emails">
													...
													<?php echo esc_html__( 'Display in emails', 'shopglut' ); ?>
												</label><br>
												<label for="new_field_display_in_order">
													...
													<?php echo esc_html__( 'Display in order details', 'shopglut' ); ?>
												</label>
											</fieldset>
										</td>
									</tr>
								...
								<div class="shopglut-checkout-manager-card-footer">
									<input type="submit" name="add_field" class="shopglut-checkout-manager-button"
										value="<?php echo esc_attr__( 'Add Field', 'shopglut' ); ?>">
								</div>
							</form>
						</div>
					</div>
		...
		<div
			...
			<?php if ( $current_tab === 'block_fields' ) : ?>
				<div class="shopglut-checkout-manager-card">
					<div class="shopglut-checkout-manager-card-header">
						<h3><?php echo esc_html__( 'Block Checkout Fields', 'shopglut' ); ?>
							<div class="drag-instruction">
								<span class="dashicons dashicons-info"></span>
								<?php echo esc_html__( 'Drag and drop rows to reorder fields', 'shopglut' ); ?>
							</div>
					...
					<div class="shopglut-checkout-manager-card-content">
						<div class="shopglut-checkout-manager-info-box info compact">
							<h4><span class="dashicons dashicons-info"></span> <?php echo esc_html__( 'WooCommerce Blocks Support', 'shopglut' ); ?></h4>
							<p><?php echo esc_html__( 'Block checkout supports a limited set of field types.', 'shopglut' ); ?><br>
							<strong><?php echo esc_html__( 'Supported types:', 'shopglut' ); ?></strong> <?php echo esc_html__( 'Text, Select, Checkbox', 'shopglut' ); ?></p>
						</div>
								...
								<table class="shopglut-checkout-manager-table shopglut-checkout-manager-fields-table widefat">
									...
									<tbody>
										...
										<?php else : ?>
											<tr>
												<td colspan="6">
													<?php echo esc_html__( 'No block checkout fields found for this section. Add your first block checkout field using the "Add New Field" tab.', 'shopglut' ); ?>
												</td>
											</tr>
										<?php endif; ?>
									</tbody>
						...
						<div id="block-add-new-field" class="shopglut-checkout-manager-section-content">
							<div class="shopglut-checkout-manager-card">
								<div class="shopglut-checkout-manager-card-header">
									<h3><?php echo esc_html__( 'Add New Block Checkout Field', 'shopglut' ); ?></h3>
								</div>
								<div class="shopglut-checkout-manager-card-content">
									<form method="post" action="" id="add-block-field-form">
										...
										<table class="shopglut-checkout-manager-form-table">
											<tr>
												<th scope="row">
													<label
														for="new_block_field_section"><?php echo esc_html__( 'Section', 'shopglut' ); ?></label>
												</th>
												<td>
											...
											<tr>
												<th scope="row">
													<label
														for="new_block_field_id"><?php echo esc_html__( 'Field ID', 'shopglut' ); ?></label>
												</th>
												<td>
											...
											<tr>
												<th scope="row">
													<label
														for="new_block_field_type"><?php echo esc_html__( 'Field Type', 'shopglut' ); ?></label>
												</th>
												<td>
													...
													<p class="description">
														<?php echo esc_html__( 'Only these field types are currently supported in block checkout.', 'shopglut' ); ?>
													</p>
												</td>
											</tr>
											<tr>
												<th scope="row">
													<label
														for="new_block_field_label"><?php echo esc_html__( 'Label', 'shopglut' ); ?></label>
												</th>
												<td>
											...
											<tr>
												<th scope="row">
													<label
														for="new_block_field_placeholder"><?php echo esc_html__( 'Placeholder', 'shopglut' ); ?></label>
												</th>
												<td>
											...
											<tr>
												<th scope="row">
													<label
														for="new_block_field_priority"><?php echo esc_html__( 'Priority', 'shopglut' ); ?></label>
												</th>
												<td>
											...
											<tr class="block-field-options" style="display:none;">
												<th scope="row">
													<label
														for="new_block_field_options"><?php echo esc_html__( 'Options', 'shopglut' ); ?></label>
												</th>
												<td>
													<textarea name="new_block_field_options" id="new_block_field_options"
														rows="5" cols="50"></textarea>
													<p class="description">
														<?php echo esc_html__( 'Enter each option on a new line. Format: value|label (e.g. option_1|Option 1).', 'shopglut' ); ?>
													</p>
												</td>
											</tr>
											<tr>
										...
										<div class="shopglut-checkout-manager-card-footer">
											<input type="submit" name="add_block_field"
												...
												value="<?php echo esc_attr__( 'Add Block Field', 'shopglut' ); ?>">
										</div>
									</form>
								</div>
							</div>
		...
		<div class="shopglut-checkout-manager-dialog" id="edit-block-field-dialog">
			<div class="shopglut-checkout-manager-dialog-header">
				<h2><?php echo esc_html__( 'Edit Block Field', 'shopglut' ); ?></h2>
				...
				<form method="post" action="" id="edit-block-field-form">
					...
					<table class="shopglut-checkout-manager-form-table">
						<tr>
							<th scope="row">
								<label
									for="edit_block_field_section"><?php echo esc_html__( 'Section', 'shopglut' ); ?></label>
							</th>
							<td>
						...
						<tr>
							<th scope="row">
								<label
									for="edit_block_field_id"><?php echo esc_html__( 'Field ID', 'shopglut' ); ?></label>
							</th>
							<td>
						...
						<tr>
							<th scope="row">
								<label
									for="edit_block_field_type"><?php echo esc_html__( 'Field Type', 'shopglut' ); ?></label>
							</th>
							<td>
						...
						<tr>
							<th scope="row">
								<label
									for="edit_block_field_label"><?php echo esc_html__( 'Label', 'shopglut' ); ?></label>
							</th>
							<td>
						...
						<tr>
							<th scope="row">
								<label
									for="edit_block_field_placeholder"><?php echo esc_html__( 'Placeholder', 'shopglut' ); ?></label>
							</th>
							<td>
						...
						<tr>
							<th scope="row">
								<label
									for="edit_block_field_priority"><?php echo esc_html__( 'Priority', 'shopglut' ); ?></label>
							</th>
							<td>
						...
						<tr class="block-field-options-edit" style="display:none;">
							<th scope="row">
								<label
									for="edit_block_field_options"><?php echo esc_html__( 'Options', 'shopglut' ); ?></label>
							</th>
							<td>
			...
			<div class="shopglut-checkout-manager-dialog-footer">
				<button type="button"
					class="shopglut-checkout-manager-button secondary cancel-button"><?php echo esc_html__( 'Cancel', 'shopglut' ); ?></button>
				<button type="button"
					class="shopglut-checkout-manager-button update-block-field-button"><?php echo esc_html__( 'Update Field', 'shopglut' ); ?></button>
			</div>
		</div>
		...
		<div class="shopglut-checkout-manager-tab-content <?php echo $current_tab === 'advanced' ? 'active' : ''; ?>">
			<?php if ( $current_tab === 'advanced' ) : ?>
				<form method="post" action="">
					...
					<div class="shopglut-checkout-manager-card">
						<div class="shopglut-checkout-manager-card-header">
							<h3><?php echo esc_html__( 'Locale Override Settings', 'shopglut' ); ?></h3>
						</div>

						<div class="shopglut-checkout-manager-card-content">
							<p class="description">
								<?php echo esc_html__( 'These settings control whether your field customizations override the default WooCommerce locale settings.', 'shopglut' ); ?>
							</p>
							...
							<div class="shopglut-checkout-manager-settings-section">
								<div class="shopglut-checkout-manager-settings-row">
									...
									<label
										for="enable_label_override"><?php echo esc_html__( 'Enable label override for address fields', 'shopglut' ); ?></label>
								</div>
								...
								<div class="shopglut-checkout-manager-settings-row">
									...
									<label
										for="enable_placeholder_override"><?php echo esc_html__( 'Enable placeholder override for address fields', 'shopglut' ); ?></label>
								</div>
								...
								<div class="shopglut-checkout-manager-settings-row">
									...
									<label
										for="enable_class_override"><?php echo esc_html__( 'Enable class override for address fields', 'shopglut' ); ?></label>
								</div>
								...
								<div class="shopglut-checkout-manager-settings-row">
									...
									<label
										for="enable_priority_override"><?php echo esc_html__( 'Enable priority override for address fields', 'shopglut' ); ?></label>
								</div>
								...
								<div class="shopglut-checkout-manager-settings-row">
									...
									<label
										for="enable_required_override"><?php echo esc_html__( 'Enable required validation override for address fields', 'shopglut' ); ?></label>
								</div>
							</div>
						</div>
						<div class="shopglut-checkout-manager-card-footer">
							<input type="submit" name="save_settings" class="shopglut-checkout-manager-button"
								value="<?php echo esc_attr__( 'Save Changes', 'shopglut' ); ?>">
							<input type="submit" name="reset_settings" class="shopglut-checkout-manager-button secondary"
								value="<?php echo esc_attr__( 'Reset to Default', 'shopglut' ); ?>"
								onclick="return confirm('<?php echo esc_js( __( 'Are you sure you want to reset to default settings? All your changes will be lost.', 'shopglut' ) ); ?>')">
						</div>
					</div>
				</form>
			<?php endif; ?>
		...
		<div
			...
			<?php if ( $current_tab === 'import_export' ) : ?>
				<div class="shopglut-checkout-manager-card">
					<div class="shopglut-checkout-manager-card-header">
						<h3><?php echo esc_html__( 'Import/Export Settings', 'shopglut' ); ?></h3>
					</div>
					<div class="shopglut-checkout-manager-card-content">
						<div class="shopglut-checkout-manager-info-box info">
							...
							<div class="shopglut-checkout-manager-info-box-content">
								<p><?php echo esc_html__( 'You can transfer the saved settings data between different installs by copying the text inside the box below. To import settings, paste the exported data in the import box and click "Import Settings".', 'shopglut' ); ?>
								</p>
							</div>
						</div>

						<div class="shopglut-checkout-manager-import-export">
							<h4><?php echo esc_html__( 'Export Settings', 'shopglut' ); ?></h4>
							<p><?php echo esc_html__( 'Copy the contents of this field to save your settings data.', 'shopglut' ); ?>
							</p>
						...
						<div class="shopglut-checkout-manager-import-export">
							<h4><?php echo esc_html__( 'Import Settings', 'shopglut' ); ?></h4>
							<p><?php echo esc_html__( 'Paste your exported settings data here and click "Import Settings" to restore your settings.', 'shopglut' ); ?>
							</p>
							<form method="post" action="">
								<?php wp_nonce_field( 'shopglut_checkout_fields_action', 'shopglut_checkout_fields_nonce' ); ?>
								...
								<p>
									<input type="submit" name="import_settings" class="shopglut-checkout-manager-button"
										value="<?php echo esc_attr__( 'Import Settings', 'shopglut' ); ?>"
										onclick="return confirm('<?php echo esc_js( __( 'Are you sure you want to import these settings? All current settings will be replaced.', 'shopglut' ) ); ?>')">
								</p>
							</form>
						</div>
					</div>
...
<div class="shopglut-checkout-manager-dialog" id="edit-field-dialog">
	<div class="shopglut-checkout-manager-dialog-header">
		<h2><?php echo esc_html__( 'Edit Field', 'shopglut' ); ?></h2>
		<span class="shopglut-checkout-manager-dialog-close">&times;</span>
	</div>
	<div class="shopglut-checkout-manager-dialog-content">
		<form method="post" action="" id="edit-field-form">
			...
			<table class="shopglut-checkout-manager-form-table">
				<tr>
					<th scope="row">
						<label for="edit_field_section"><?php echo esc_html__( 'Section', 'shopglut' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="edit_field_id"><?php echo esc_html__( 'Field ID', 'shopglut' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="edit_field_type"><?php echo esc_html__( 'Field Type', 'shopglut' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="edit_field_label"><?php echo esc_html__( 'Label', 'shopglut' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label
							for="edit_field_placeholder"><?php echo esc_html__( 'Placeholder', 'shopglut' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="edit_field_class"><?php echo esc_html__( 'CSS Class', 'shopglut' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label for="edit_field_priority"><?php echo esc_html__( 'Priority', 'shopglut' ); ?></label>
					</th>
					<td>
				...
				<tr class="field-options-edit" style="display:none;">
					<th scope="row">
						<label for="edit_field_options"><?php echo esc_html__( 'Options', 'shopglut' ); ?></label>
					</th>
					<td>
				...
				<tr>
					...
					<td>
						<fieldset>
							<legend class="screen-reader-text"><?php echo esc_html__( 'Validation', 'shopglut' ); ?>
							</legend>
	...
	<div class="shopglut-checkout-manager-dialog-footer">
		<button type="button"
			class="shopglut-checkout-manager-button secondary cancel-button"><?php echo esc_html__( 'Cancel', 'shopglut' ); ?></button>
		<button type="button"
			class="shopglut-checkout-manager-button update-field-button"><?php echo esc_html__( 'Update Field', 'shopglut' ); ?></button>
	</div>
</div>
...
<div class="shopglut-checkout-manager-dialog" id="delete-field-dialog">
	<div class="shopglut-checkout-manager-dialog-header">
		<h2><?php echo esc_html__( 'Delete Field', 'shopglut' ); ?></h2>
		<span class="shopglut-checkout-manager-dialog-close">&times;</span>
	</div>
	<div class="shopglut-checkout-manager-dialog-content">
		<p><?php echo esc_html__( 'Are you sure you want to delete this field? This action cannot be undone.', 'shopglut' ); ?>
		</p>
	...
	<div class="shopglut-checkout-manager-dialog-footer">
		<button type="button"
			class="shopglut-checkout-manager-button secondary cancel-button"><?php echo esc_html__( 'Cancel', 'shopglut' ); ?></button>
		<button type="button"
			class="shopglut-checkout-manager-button danger delete-field-button"><?php echo esc_html__( 'Delete Field', 'shopglut' ); ?></button>
	</div>
</div>
