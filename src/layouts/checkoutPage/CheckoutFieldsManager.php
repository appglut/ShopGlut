<?php
namespace Shopglut\layouts\checkoutPage;
...
class CheckoutFieldsManager {
	...
	public function enqueueAdminScripts( $hook ) {
		...
		if ( ! isset( $_GET['page'] ) || sanitize_text_field( wp_unslash( $_GET['page'] ) ) !== $this->menu_slug ) {
			return;
		}
...
// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching
	...
	public function renderAdminPage() {
		...
		// Check if checkout_page module is disabled
		$module_manager = \Shopglut\ModuleManager::get_instance();
		if ($module_manager->should_show_disabled_message('checkout_page')) {
...
// phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching
		...
		// Handle other form submissions (update, delete, etc.)
		// ... (rest of the processFormSubmission method remains the same)
